...
def sgd_momentum(w, dw, config=None):
  ...
  # ================================================================ #
  lr, alpha = config.get('learning_rate'), config.get('momentum')
  v = (alpha * v) - (lr * dw)  # update momentum vector
  next_w = w + v  # grad step
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def sgd_nesterov_momentum(w, dw, config=None):
  ...
  lr, alpha = config.get('learning_rate'), config.get('momentum')
  v_old = v
  v = (alpha * v_old) - (lr * dw)  # update v step  
  next_w = w + v + alpha * (v - v_old)  # grad step
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def rmsprop(w, dw, config=None):
  ...
  # ================================================================ #
  lr, beta, eps, a = config['learning_rate'], config['decay_rate'], config['epsilon'], config['a']
  a = beta * a + (1-beta) * dw * dw  # update a step
  next_w = w - (lr / (np.sqrt(a) + eps)) * dw # grad step
  config['a'] = a
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def adam(w, dw, config=None):
  ...
  eps, v, a, t = config['epsilon'], config['v'], config['a'], config['t']
  t += 1
  # first moment update
  v = b1 * v + (1-b1) * dw
  ...
  a_c = a / (1 - b2**t)
  # gradient step
  next_w = w - (lr / (np.sqrt(a_c) + eps)) * v_c
  config['v'], config['a'] = v, a
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
